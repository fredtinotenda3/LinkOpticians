// ===== FILE: app/(public)/locations/[branchId]/page.tsx (FULL REPLACEMENT) =====
    ...
    <div className="min-h-screen bg-[#000d1a]">
      ...
      <section className="relative min-h-[85vh] w-full overflow-hidden flex items-center">
        <div className="absolute inset-0">
          <Image
            src={branch.image || "/assets/images/branches/fallback.jpg"}
            alt={branch.name}
            fill
        ...
        <div className="mx-auto max-w-7xl px-[5%]">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              ...
              { label: "Parking", value: branch.parking || "Available", icon: "M5 8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8m-9 4h4" },
            ...
            <div className="space-y-10">
              <div className="space-y-4">
                ...
                <h2 className="text-5xl md:text-6xl font-black text-white leading-[0.9] tracking-tighter uppercase italic">
                  {aboutContent?.title || "State-of-the-art facility"}
                </h2>
                <p className="text-white/60 text-lg font-medium leading-relaxed italic">
                  {aboutContent?.text || "Comprehensive optometry services at this location."}
                </p>
              </div>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {(branch.services || branch.specialties || []).slice(0, 4).map((spec: string, i: number) => (
      ...
      <section className="py-32 bg-[#001226] overflow-hidden">
        <div className="mx-auto max-w-7xl px-[5%]">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {(branch.doctors || []).map((doctor: string, i: number) => (
              <div key={i} className="group relative aspect-[3/4] rounded-[32px] overflow-hidden border border-white/5">
                <Image 
                  ...
                  onError={(e) => {
                    ...
                    (e.target as HTMLImageElement).src = "/assets/images/doctor-default.jpg";
                  }}
                />
