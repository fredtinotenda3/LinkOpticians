      ...
      <div className="relative mx-auto max-w-4xl px-[5%]">
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-green-500 to-green-600 shadow-[0_30px_80px_rgba(36,174,124,0.35)]">
          ...
          <div className="relative z-10 px-8 md:px-16 py-16 text-center">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-white leading-tight mb-5">{title}</h2>
            <p className="text-white/80 text-lg max-w-xl mx-auto mb-10 leading-relaxed">{description}</p>
            ...
            <div className="pt-8 border-t border-white/20">
              <div className="inline-flex flex-col sm:flex-row items-center gap-3">
                ...
                <div className="text-center sm:text-left">
                  <p className="text-white/70 text-xs font-medium uppercase tracking-wider">{emergencyText}</p>
                  <div className="flex items-center gap-2 mt-0.5 justify-center sm:justify-start">
                    <a href={`tel:${emergencyPhone.replace(/\D/g, "")}`} className="text-white font-bold text-xl hover:text-white/90 transition-colors">
                      {emergencyPhone}
                    </a>
