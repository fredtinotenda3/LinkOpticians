...
export const FinalCTASection = ({
  ...
  description = "Book your appointment today. We'll confirm within 24 hours.",
  primaryButtonText = "Book online",
  primaryButtonHref = "/book",
  secondaryButtonText = "Find a clinic",
  secondaryButtonHref = "/locations",
  emergencyText = "Emergency? Call our 24/7 line",
  emergencyPhone = "+263 77 340 7464",
  showEmergency = true,
}: FinalCTASectionProps) => {
  return (
    <section className="relative py-24 bg-dark-300 overflow-hidden">
      ...
      <div className="relative mx-auto max-w-4xl px-[5%]">
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-green-500 to-green-600 shadow-[0_30px_80px_rgba(36,174,124,0.35)]">
          ...
          {/* Background texture — organic circles instead of flat grid */}
          ...
          <div className="relative z-10 px-8 md:px-16 py-16 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              ...
              {/* Secondary — white outline with stronger visibility */}
              <Link
