          ...
          <div className="relative z-10 px-8 md:px-16 py-16 text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
              <a
                ...
                className="group inline-flex items-center gap-3 bg-white text-green-600 font-bold px-8 py-4 rounded-full shadow-xl hover:shadow-2xl hover:scale-[1.03] transition-all duration-300"
              >
              ...
              <Link
                href="/book"
                className="inline-flex items-center gap-2 bg-white/15 hover:bg-white/25 border border-white/40 hover:border-white/70 text-white font-semibold px-8 py-4 rounded-full backdrop-blur-sm transition-all duration-300"
              >
                Book online instead
