// components/sections/products/detail/ProductDetailCTASection.tsx
...
export const ProductDetailCTASection = ({
  title,
  description,
  primaryButtonText,
  primaryButtonHref,
      ...
      <div className="relative mx-auto max-w-5xl px-[5%]">
        <div className="relative overflow-hidden rounded-[48px] bg-gradient-to-br from-[#001a33] to-[#000d1a] border border-white/10 shadow-[0_40px_100px_rgba(0,0,0,0.4)]">
          ...
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            <div className="absolute -top-24 -right-24 w-96 h-96 rounded-full bg-sky-500/5 blur-3xl" />
            <div className="absolute -bottom-32 -left-32 w-80 h-80 rounded-full bg-sky-400/5 blur-3xl" />
            
            <svg className="absolute inset-0 w-full h-full opacity-[0.04]" xmlns="http://www.w3.org/2000/svg">
              <defs>
                <pattern id="detail-cta-dots" x="0" y="0" width="32" height="32" patternUnits="userSpaceOnUse">
                  <circle cx="2" cy="2" r="1" fill="white" />
                </pattern>
              </defs>
              <rect width="100%" height="100%" fill="url(#detail-cta-dots)" />
            </svg>
          </div>
          ...
          <div className="relative z-10 px-8 md:px-20 py-24 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              ...
              <Link
                ...
                className="inline-flex items-center justify-center gap-2 bg-white/5 hover:bg-white/10 border border-white/10 hover:border-white/20 text-white font-black text-[11px] uppercase tracking-[0.2em] px-10 py-5 rounded-full backdrop-blur-md transition-all duration-500 hover:-translate-y-1"
              >
                {secondaryButtonText}
              </Link>
            </div>
